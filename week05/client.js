...
class ResponseParser{
    ...
    receiveChar(char){
        if(this.currentStatus === this.WAITING_STATUS_LINE){ //等待statusLine
        ...
        }else if(this.currentStatus === this.WAITING_STATUS_LINE_END){ //等待statusLine
            if(char === '\n'){ // 接收到 \n 代表结束，该改变状态了
                this.currentStatus = this.WAITING_HEADER_NAME;
            }
        ...
        }else if(this.currentStatus === this.WAITING_HEADER_BLOCK_END){ //等待statusLine
            if(char === '\n'){ // 接收到 \n 代表结束，该改变状态了
...
class TrunkedBodyParser{
    ...
    receiveChar(char){
        ...
        if(this.currentStatus === this.WAITING_LENGTH){ //等待statusLine
            if(char === '\r'){ // 接收到 \r 代表结束，该改变状态了
                if(this.length === 0){
